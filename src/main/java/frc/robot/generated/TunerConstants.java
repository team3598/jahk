...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.21); //original 5.21
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.033203125);
